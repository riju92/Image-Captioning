...
# script to download the COCO dataset. This script downloads 13 GB of data including train2014 and annotations directories

class COCO(object):
    def __init__(self, annotations_folder, image_folder):
        print("[-STATUS-] Instantiated COCO")
    ...
    def download_annotations(self):
        ...
        if not os.path.exists(os.path.abspath('.') + self.annotations_folder):
            print("[-STATUS-] Downloading COCO annotations")
            ...
            print("[-STATUS-] Annotations folder exists. Fetching annotations from PC.")
    ...
    def download_images(self):
        ...
        if not os.path.exists(os.path.abspath('.') + self.image_folder):
            print("[-STATUS-] Downloading COCO images (13 GB)")
            ...
            print("[-STATUS-] Train images folder exists. Fetching images from PC.")
